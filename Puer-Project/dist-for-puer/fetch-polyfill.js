...
if (!globalThis.DOMException) {
  try {
    const { MessageChannel } = __webpack_require__(4564),
...
if (!globalThis.ReadableStream) {
  ...
  try {
    const process = __webpack_require__(6968)
    const { emitWarning } = process
    try {
      process.emitWarning = () => {}
      Object.assign(globalThis, __webpack_require__(1429))
...
try {
  ...
  const { Blob } = __webpack_require__(871)
...
/* harmony import */ var _streams_cjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4151);
...
var from = __webpack_require__(2391);
...
;// CONCATENATED MODULE: ./src-for-puer/fetch-polyfill.js
